Feature: Unreferenced Files can handle multiple files and directories being passed as parameters to search and search for.
  ...
  Scenario Outline:
    ...
    Examples:
      | repository                             | checkout_commit                          | search_file    | search_for               | search_for_2               | unreferenced_files                                       |
  ...
  Scenario Outline:
    ...
    Examples:
      | repository                             | checkout_commit                          | search_file | search_dir | search_for               | search_for_2         |

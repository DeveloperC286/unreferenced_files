...
#[test]
fn test_file_stem_searching_for_relative_path_found() {
    // Given
...
#[test]
fn test_file_stem_searching_for_file_name_found() {
    // Given
    let searching_for = [FilePathVariants {
        file_canonicalize_path: "/tmp/folder/file1.txt".to_string(),
        file_relative_path: "./folder/file1.txt".to_string(),
...
#[test]
fn test_file_stem_searching_for_file_stem_found() {
    // Given
    let searching_for = [FilePathVariants {
        file_canonicalize_path: "/tmp/folder/file1.txt".to_string(),
        file_relative_path: "./folder/file1.txt".to_string(),
...
#[test]
fn test_file_stem_searching_for_not_found() {
    // Given
    let searching_for = [FilePathVariants {
        file_canonicalize_path: "/tmp/folder/file1.txt".to_string(),
        file_relative_path: "./folder/file1.txt".to_string(),
